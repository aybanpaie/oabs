          ...
          <div className="card shadow-lg login-card">
            <div className="card-body p-4">
              <div className="text-center mb-4">
                ...
                <h4 className="fw-semibold text-dark mb-1">Online Business Permit &</h4>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="d-flex justify-content-between mb-4">
                  <Link to="/create/user" className="text-decoration-none" style={{ color: '#dc3545' }}>
                    Create a new account
                  </Link>
                  <Link to="/forgot/user" className="text-decoration-none" style={{ color: '#dc3545' }}>
                    Forgot Password?
                  </Link>
                </div>
                <Link
